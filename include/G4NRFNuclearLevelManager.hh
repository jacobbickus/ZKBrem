...
public:
  ...
  const G4NRFNuclearLevel* NearestLevel(const G4double energy, const G4double eDiffMax=9999.*GeV);

  const G4NRFNuclearLevel* NearestLevelRecoilAbsorb(const G4double GammaEnergy, 
                                                    const G4double eDiffMax=9999.*GeV);

  const G4NRFNuclearLevel* NearestLevelRecoilEmit(const G4double LevelEnergy, 
