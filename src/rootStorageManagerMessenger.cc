  ...
  : theRSManager(RSM)
{
  ...
  rootDirectory->SetGuidance("Settings for ZKBrem I/O via persistent ROOT data storage");
  ...
  rootFileNameCmd->SetGuidance("default file name will be 'ACRONYM_<date>_<time>.root'.");
